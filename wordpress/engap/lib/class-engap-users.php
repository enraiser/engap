...
class ENGAP_Users {
	...
	public function register_routes( $routes ) {
		$user_routes = array(
			// User endpoints
			'/users' => array(
				array( array( $this, 'get_users' ),        ENGAP_Server::READABLE ),
				array( array( $this, 'create_user' ),      ENGAP_Server::CREATABLE | ENGAP_Server::ACCEPT_JSON ),
			),
			'/users/(?P<id>\d+)' => array(
				array( array( $this, 'get_user' ),         ENGAP_Server::READABLE ),
				array( array( $this, 'edit_user' ),        ENGAP_Server::EDITABLE | ENGAP_Server::ACCEPT_JSON ),
				array( array( $this, 'delete_user' ),      ENGAP_Server::DELETABLE ),
			),
			// /users/me is an alias, and simply redirects to /users/<id>
			'/users/me' => array(
				array( array( $this, 'get_current_user' ), ENGAP_Server::READABLE ),
			),
		);
	...
	public function new_user( $data ) {
		_deprecated_function( __CLASS__ . '::' . __METHOD__, 'WPAPI-1.2', 'ENGAP_Users::create_user' );
